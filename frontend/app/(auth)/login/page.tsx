            ...
            <form onSubmit={handleLogin} className="space-y-5">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between ml-1">
                        ...
                        <Link href="/forgot-password" className="text-xs text-[#d9e838] hover:text-[#c9d828] transition-colors font-semibold">
                            Forgot Password?
                        </Link>
                    </div>
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full bg-[#011d16] border border-white/10 rounded-xl pl-12 pr-12 py-3.5 text-white focus:outline-none focus:border-[#d9e838]/50 focus:bg-[#011d16] transition-all placeholder:text-gray-600 font-medium"
                            placeholder="••••••••"
                        />
                        <button
                            type="button"
