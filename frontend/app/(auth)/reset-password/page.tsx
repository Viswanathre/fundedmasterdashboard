        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#011d16] p-4">
                ...
                >
                    ...
                    <h2 className="text-2xl font-black text-white mb-4">Password updated!</h2>
                    <p className="text-gray-400 mb-8 leading-relaxed">
                        Your password has been successfully reset. You can now log in with your new password.
                    </p>
                    <Link
                        href="/login"
                        className="inline-flex items-center justify-center gap-2 w-full bg-[#d9e838] hover:bg-[#c9d828] text-black font-semibold py-3 rounded-xl transition-all"
                    >
                        Back to Login
                    </Link>
                </motion.div>
        ...
        >
            <form onSubmit={handleResetPassword} className="space-y-5">
                <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1" htmlFor="password">New Password</label>
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full bg-[#011d16] border border-white/10 rounded-xl pl-12 pr-12 py-3.5 text-white focus:outline-none focus:border-[#d9e838]/50 transition-all placeholder:text-gray-600 font-medium"
                            placeholder="••••••••"
                        />
                        <button
                            type="button"
                ...
                <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1" htmlFor="confirmPassword">Confirm Password</label>
                    <div className="relative group">
                        <Lock className="absolute left-4 top-3.5 w-5 h-5 text-gray-500 group-focus-within:text-[#d9e838] transition-colors" />
                        <input
                            id="confirmPassword"
